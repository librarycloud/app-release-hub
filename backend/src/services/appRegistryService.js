...
export function registerApp({ appId, name, platform = "android", githubRepo = "", githubApiUrl = "https://api.github.com", autoSync = false }) {
  ...
  insertApp({ appId, name, platform, githubRepo, githubApiUrl, autoSync });
